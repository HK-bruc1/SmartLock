...
void TIM3_ch4_LCD_Pwm(void)
{
	...
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_1 ;							 //  9
	...
	TIM_OCInitStruct.TIM_OCPolarity = TIM_OCPolarity_High; //电平有效
	TIM_OCInitStruct.TIM_OutputState = TIM_OutputState_Enable;  //输出使能
	TIM_OCInitStruct.TIM_Pulse = 1000;                            //比较寄存器的值
