...
/***************根据自己需求更改****************/
// MFRC522射频模块 GPIO宏定义
#define   RC522_DELAY()  tim5Delay_Us(2)

 
/*********************************** RC522 引脚定义 *********************************************/
#define               MFRC522_GPIO_SDA_PORT    	               		GPIOA			   
#define               MFRC522_GPIO_SDA_PIN		                   	GPIO_Pin_15
											
#define               MFRC522_GPIO_SCK_PORT    	              		GPIOC			   
#define               MFRC522_GPIO_SCK_PIN		                  	GPIO_Pin_10
											
#define               MFRC522_GPIO_MOSI_PORT    	              	GPIOC			   
#define               MFRC522_GPIO_MOSI_PIN		                	GPIO_Pin_12
											
#define               MFRC522_GPIO_MISO_PORT    	              	GPIOC			   
#define               MFRC522_GPIO_MISO_PIN		                		GPIO_Pin_11
											
#define               MFRC522_GPIO_RST_PORT    	              		GPIOD		   
#define               MFRC522_GPIO_RST_PIN		                  	GPIO_Pin_2
